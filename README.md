...
- crawler-reddit/: script lấy dữ liệu real-time từ bình luận trên các nhóm trên reddit
- web_app/: Flask app + dashboard
- postgres/: init.sql để tạo bảng khi Postgres khởi động
- docker-compose.yml để khởi tạo stack (Postgres, Zookeeper, Kafka, crawler-reddit, flink, spark, web_app)
